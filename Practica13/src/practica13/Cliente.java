...
public class Cliente {
    ...
    private static int bitString(String str) {
        ...
        como usamos la secuencia como la cadena a enviar, a partir del 10 ping, el
        envío será de 32 bits.
        */
        ...
        while (true) {
            ...
            try {
                ...
                */
                ...
                System.out.println(respuesta+": Tiempo de respuesta aproximado: " + (t2 - t1) + " milisegundos. Pérdida: " + (bitString(envio) - bitString(respuesta)) + " bits.");
